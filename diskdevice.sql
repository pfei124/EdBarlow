...
update #dev_tbl
	...
	set disk_size = ((1. + (d.high - d.low))*@@pagesize) / 1048576.
...
if @dont_format is not null
	...
	select
			"Device Name"=substring(name,1,28),
			"Physical Name"=substring(phyname,1,51),
