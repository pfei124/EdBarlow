...
begin
   drop procedure sp__flowchart
end
go

create procedure sp__flowchart (
...
select "level 1"=substring(isnull(object_name(level1),""),1,20),
       "level 2"=substring(isnull(object_name(level2),""),1,20),
       "level 3"=substring(isnull(object_name(level3),""),1,20),
       "level 4"=substring(isnull(object_name(level4),""),1,20)
from #output
