...
begin
    drop procedure sp__helpuser2
end
go

create procedure sp__helpuser2 (
...
begin
   ...
   and   d.suid!=1
        ...
        if @dont_format is null
                select
                        Login_name, User_name, "Alias"=isnull(Is_Alias,""),User_uid,
...
grant execute on sp__helpuser2 to public
go
